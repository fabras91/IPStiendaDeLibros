...
<blockquote>
	...
	<input class="hi" style="float: right; margin: 2%;" type="button" name="cancel" value="Inicio" onClick="window.location='index.php';" />
</blockquote>
</header>
<?php
session_start();
...
if(isset($_SESSION['id'])){
	...
	echo '<blockquote>';
?>
<input class="button" style="float: right;" type="button" name="cancel" value="Continuar Comprando" onClick="window.location='index.php';" />
<?php
	echo '<h2 style="color: #000;">Gracias por su Compra!</h2>';
	echo "<table style='width:100%'>";
	echo "<tr><th>Resumen del Pedido</th>";
	echo "<th></th></tr>";
	$row = $result->fetch_assoc();
	echo "<tr><td>Nombre: </td><td>".$row['CustomerName']."</td></tr>";
	echo "<tr><td>DNI: </td><td>".$row['CustomerIC']."</td></tr>";
	echo "<tr><td>E-mail: </td><td>".$row['CustomerEmail']."</td></tr>";
	echo "<tr><td>Número Telefónico: </td><td>".$row['CustomerPhone']."</td></tr>";
	echo "<tr><td>Género: </td><td>".$row['CustomerGender']."</td></tr>";
	echo "<tr><td>Dirección: </td><td>".$row['CustomerAddress']."</td></tr>";
	echo "<tr><td>Fecha: </td><td>".$row['DatePurchase']."</td></tr>";
	echo "</blockquote>";
	...
	while($row = $result->fetch_assoc()){
    	...
    	echo $row['BookTitle']."<br>S/. ".$row['Price']."<br>";
    	echo "Cantidad: ".$row['Quantity']."<br>";
    	echo "</td></tr>";
    	$total += $row['TotalPrice'];
	}
	echo "<tr><td style='background-color: #ccc;'></td><td style='text-align: right;background-color: #ccc;''>Precio Total: <b>S/. ".$total."</b></td></tr>";
	echo "</table>";
	echo "</div>";
...
if(!isset($_SESSION['id'])){
	...
	echo 'Nombre:<br><input type="text" name="name" placeholder="Nombre Completo">';
	echo '<span class="error" style="color: red; font-size: 0.8em;"><?php echo $nameErr;?></span><br><br>';

	echo 'DNI:<br><input type="text" name="ic" placeholder="xxxxxxxxx-x">';
	...
	echo 'Número Telefónico:<br><input type="text" name="contact" placeholder="3456789">';
	echo '<span class="error" style="color: red; font-size: 0.8em;"><?php echo $contactErr;?></span><br><br>';

	echo '<label>Género:</label><br>';
	echo '<input type="radio" name="gender" if (isset($gender) && $gender == "Male") echo "checked"; value="Male">Hombre';
	echo '<input type="radio" name="gender" if (isset($gender) && $gender == "Female") echo "checked"; value="Female">Mujer';
	echo '<span class="error" style="color: red; font-size: 0.8em;"><?php echo $genderErr;?></span><br><br>';

	echo '<label>Dirección:</label><br>';
	   echo '<textarea name="address" cols="30" rows="5" placeholder="Dirección de Domicilio"></textarea>';
