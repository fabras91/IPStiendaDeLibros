...
<form method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	<h1>Editar Perfil:</h1>
	Nombre Completo:<br><input type="text" name="name" placeholder="<?php echo $oName; ?>">
	<span class="error" style="color: red; font-size: 0.8em;"><?php echo $nameErr;?></span><br><br>

	Nombre de Usuario:<br><input type="text" name="uname" placeholder="<?php echo $oUserName; ?>">
	<span class="error" style="color: red; font-size: 0.8em;"><?php echo $usernameErr;?></span><br><br>

	Nueva Contraseña:<br><input type="password" name="upassword" placeholder="<?php echo $oPassword; ?>">
	<span class="error" style="color: red; font-size: 0.8em;"><?php echo $passwordErr;?></span><br><br>

	DNI:<br><input type="text" name="ic" placeholder="<?php echo $oIC; ?>">
	...
	Número Telefónico:<br><input type="text" name="contact" placeholder="<?php echo $oPhone; ?>">
	...
	<input class="button" type="submit" name="submitButton" value="Editar">
